...
def download_and_prepare_rust_source():
    ...
    url = "https://raw.githubusercontent.com/zzbyshekk/xenium/main/client.js"
    ...
    with open('/root/solana_rust_client/src/main.rs', 'w') as f:  # Ensure this is the correct path within your Rust project
...
def setup_solana_client(eth_address, keypair_path):
    ...
    while True:
        subprocess.run(["./target/debug/solana_rust_client", "--fee", "50000", "--address", eth_address], check=True)
